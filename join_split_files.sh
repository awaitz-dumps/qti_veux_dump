...
cat system/system/app/MIpay/MIpay.apk.* 2>/dev/null >> system/system/app/MIpay/MIpay.apk
rm -f system/system/app/MIpay/MIpay.apk.* 2>/dev/null
...
cat vendor_bootimg/03_dtbdump_gj3.* 2>/dev/null >> vendor_bootimg/03_dtbdump_gj3
rm -f vendor_bootimg/03_dtbdump_gj3.* 2>/dev/null
cat g.dtb.* 2>/dev/null >> g.dtb
rm -f g.dtb.* 2>/dev/null
